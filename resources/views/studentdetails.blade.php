...
<br>
	...
	<br>
	<input type="checkbox" class="parameterajax" id="parameter1" name="param[]" value="fname"> Father name 
	<input type="checkbox" class="parameterajax" id="parameter2" name="param[]" value="class"> Class 
	<input type="checkbox" class="parameterajax" id="parameter3" name="param[]" value="phnum"> Phone num
	<input type="checkbox" class="parameterajax" id="parameter3" name="param[]" value="email"> Email
...
<table class="table table-bordered scontent">
	<thead>
		...
		<th class="exam_sorting" data-sorting_type="asc" data-column_name="fname" style="cursor: pointer">F/Name</th>
		<th>Class</th>
		<th>Phone No</th>
		<th>Email</th>
    <th>Show</th>
...
$(document).ready(function(){
	...
	// dynamic column print using ajax
	$(document).on('click', '.parameterajax', function(){
     	var filter = [];
        $('.parameterajax:checked').each(function(){
            filter.push($(this).val());
        });
      $.ajax({
         url:"<?php echo url(''); ?>/studentdetails3?filter="+filter,
